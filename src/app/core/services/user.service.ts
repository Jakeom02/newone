...
export class UserService {
  ...
  // getAllUsersByRoleCare(obj) {
     // console.log(obj);
  //   return this.http.get<User>(environment.apiEndpoint + "/getAllUsersByRole/" + obj.page + "/" + obj.pageSize).pipe(
  //     map((user: any) => {
  //       return user;
  //     }),
  //     catchError(this.handleErrorObservable)
  ...
  // }
  // getlegaciUser(): User {
  //   if (localStorage.getItem("legaciUser")) {
  //     const user = JSON.parse(localStorage.getItem("legaciUser"));
  //     return user;
  //   }
  // }
  ...
  //   return this.http.put(environment.apiEndpoint + "/user/changepassword/" + id, { password: password , oldPassword : oldPassword }).pipe(
  //     map((res: any) => res),
  //     catchError(this.handleErrorObservable));
  // }
